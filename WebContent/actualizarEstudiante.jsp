...
<html>
<c:if
	test="${(not empty sessionScope.usuario) && (sessionScope.tipo == 'admin')}">
	<head>
		...
		<div class="container-fluid" id="altura">
			...
			<div class="row" style="height: 94%;">
				...
				<form class="col-9 d-flex flex-column justify-content-center"
					action="actualizarEstudianteController" method="POST">
					<div
						...
						<div
							...
							<div class="row w-50 mb-4 mx-auto">
								<input type="text" class="form-control" id="cedula"
									name="cedula" placeholder="Número de cédula"
									value="<c:out value="${Cedula}"/>" readonly>
							</div>
							...
							<div class="row w-50 mb-4 mx-auto">
								<input type="text" class="form-control" id="nombre"
									name="nombre" placeholder="Nombre del estudiante"
...
<c:if
	test="${(empty sessionScope.usuario) || (sessionScope.tipo != 'admin')}">
